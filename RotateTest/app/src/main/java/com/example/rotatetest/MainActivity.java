...
public class MainActivity extends AppCompatActivity {
    ...
    public void onConfigurationChanged (Configuration newConfig){
        ...
        } else if ( mCurrentOrientation == Configuration.ORIENTATION_LANDSCAPE ) {//If current screen is landscape
            setContentView(R.layout.activity_main_landscape);
            FindViewById();
            FindViewByIdLandscapeNewButton();
            ButtonClickListener();
            ButtonClickListenerLadscapeNewButton();
        }
    }
    ...
    void FindViewByIdLandscapeNewButton()//横屏后新增按钮 findViewById
    {
    ...
    void ButtonClickListenerLadscapeNewButton(){//横屏后新增按钮 setOnClickListener
